...
@Component
@ConfigurationProperties(prefix = "spring.kafka") // arga automáticamente todas las propiedades que empiezan con el prefijo spring.kafka.producer desde el archivo application.yml o application.properties.
